...
$stm = $db->prepare(' INSERT INTO cahier_bord( `id_employe`, `motif`, `date_depart`, `date_retour`,`date_edition`, `compteur_depart`, `destination`, 
  `prix_auto`,`prix_carb`,`id_voiture`,`autre`)
VALUES (?,?,?,?,?,?,?,?,?,?,?)');

$stm->execute([$_POST['id_employe'],$_POST['motif'],$_POST['date_depart'],$_POST['date_retour'],$_POST['date_edition'],
$_POST['compteur_depart'],$_POST['destination'],$_POST['prix_auto'],$_POST['prix_carb'],$_POST['voiture'],$_POST['autre']]);    
 
   header("LOCATION: mission-cours.php");

   $orderdate = explode('/', $_POST['date_depart']);
$year = $orderdate[0];

     $stm1 = $db->prepare('update   vignette set Somme_disp=(Somme_disp - ?) where Annee_vign=?');
$stm1->execute([$_POST['prix_carb'],$year]);

      $stm2 = $db->prepare('update   vignette_auto set Somme_disp=(Somme_disp - ?) where Annee_vign=?');
$stm2->execute([$_POST['prix_auto'],$year]);
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <span class="section">Veuillez remplir les informations D'une Mission Employer</span>

                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Employer : <span class="required">*</span></label>
                      ...
                      <option value="<?php echo $row['id_employe'] ?>"><?php echo $row['Nom']." ".$row['Prenom']; ?></option>
                      <?php } ?>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Motif de la mission <span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="motif">
                  </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Date du Départ<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="date" placeholder="" class="form-control" name="date_depart">
                  </div>
                      </div>

                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Date du retour<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="date" placeholder="" class="form-control" name="date_retour">
                  </div>
                      </div>

                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Date édition mission<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="date" placeholder="" class="form-control" name="date_edition">
                  </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Compteur KM Départ<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="compteur_depart">
                  </div>
                      </div>
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="destination">
                  </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Prix VTT<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="prix_auto">
                  </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Prix Carburant<span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="prix_carb">
                  </div>
                      </div>
...
<option value="<?php echo $row['id_voiture'] ?>"><?php echo $row['Marque']." :&nbsp;&nbsp;&nbsp;&nbsp;".$row['Matricule'];
 ?></option>
                      ...
                      <option value="Autre" >Autre</option>
                         ...
                         <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Autre : <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                        <input type="text" placeholder="" class="form-control"  name="autre">
