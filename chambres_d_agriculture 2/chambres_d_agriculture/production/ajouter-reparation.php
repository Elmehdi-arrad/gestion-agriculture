...
$stm = $db->prepare(' INSERT INTO `repartation`( `id_voiture`, `type_reparation`, `Descriptif`, `prix_rep`,`Date_Reparation`) VALUES (?,?,?,?,?)');

$stm->execute([$_POST['voiture'],$_POST['type_Reparation'],$_POST['Description'],$_POST['prix_Reparation'],$_POST['Date_Reparation']]);    
  
     

    header("LOCATION: liste-reparation.php");
   $orderdate = explode('/', $_POST['Date_Reparation']);
$year = $orderdate[0];

     $stm1 = $db->prepare('update   vignette_rep set Somme_disp=(Somme_disp - ?) where Annee_vign=?');
$stm1->execute([$_POST['prix_Reparation'],$year]);
 ...
 <li><a><i class="fa fa-table"></i> Employe <span class="fa fa-chevron-down"></span></a>
        ...
        <div class="right_col" role="main">
           ...
           <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <span class="section">Ajouter une Réparation</span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                          <select class="form-control" name="type_Reparation">
                            ...
                            <option value="Main d'ouvre">Main d'ouvre</option>
       ...
       <option value="<?php echo $row['id_voiture'] ?>"><?php echo $row['Marque']." :&nbsp;&nbsp;&nbsp;&nbsp;".$row['Matricule']; ?></option>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="prix_Reparation">
                  </div>
                      </div>
                   ...
                   <textarea id="message" required="required" class="form-control" name="Description" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="date" placeholder="" class="form-control" name="Date_Reparation">
                  </div>
                      </div>
