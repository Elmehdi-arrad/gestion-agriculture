...
$stm2 = $db->prepare('select COUNT(Annee_vign) as annee FROM vignette_auto');
...
$stm1 = $db->prepare('select Somme_disp from vignette where Annee_vign=?-1');
$stm1->execute([$_POST['Annee_vign']]);
  $row = $stm1->fetch();
$stm = $db->prepare(' INSERT INTO `vignette_auto` (`Annee_vign`, `Somme_vign`, `Avance_vign`, `Somme_repo`, `Somme_disp`) VALUES (?,?,?,?,?)');
           ...
           <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Annee : <span class="required">*</span>
                        </label>
