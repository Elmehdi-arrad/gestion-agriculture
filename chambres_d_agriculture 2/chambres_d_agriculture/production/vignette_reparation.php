...
{
  $stm = $db->prepare('delete from vignette_rep where id_vign_rep=?');
    $stm->execute([$_GET['id']]);
}
        ...
        <div class="right_col" role="main">
         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Liste vignette Réparation<small></small></h2>
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th class="center"><Small>Année</Small></th>
                          <th class="center"><Small>Somme Global</Small></th>
                          <th class="center"><Small>Reste reporte</Small></th>

                          <th class="center"><Small>Avance </Small></th>
                          <th class="center"><Small>Reliquat</Small></th>
                      
                          <th class="center"><Small>Somme Disponible</Small></th>
                          <th class="center"><Small>Ajouter reliquat</Small></th>
                          <th class="center"><Small>Supprimer/Modifier Vignette</Small></th>
                          ...
                          <tbody>
                       <?php
                $stm = $db->prepare('select * from vignette_rep 
                  order by Annee_vign DESC ');
                $stm->execute();
              ...
              ?>
                              ...
                              <tr>
 <td class="center"><Small><?php echo $row['Annee_vign'];?></Small></td>
 <td class="center"><Small><?php echo $row['Somme_vign'];?></Small></td>
 <td class="center"><Small><?php echo $row['Somme_repo'];?></Small></td>
 <td class="center"><Small><?php echo $row['Avance_vign'];?></Small></td>
 <td class="center"><Small><?php echo $row['reliquat'];?></Small></td>
 <td class="center"><Small><?php echo $row['Somme_disp'];?></Small></td>
                 ...
                 <a class="btn btn-default btn-sm" href="ajouter_reliquat_repa.php?id=<?php echo $row['id_vign_rep']; ?>">
                 <i class="glyphicon glyphicon-plus" title="Ajouter reliquat" style="color:black;"></i> 
                  </a>
                                  </td>
                          <td class="center">
                
                <a class="btn btn-default btn-sm" href="?action=delete&id=<?php echo $row['id_vign_rep']; ?>">
                 <i class="glyphicon glyphicon-trash" title="Supprimer Vignette" style="color:black;"></i> 
                  </a>
                </td>
