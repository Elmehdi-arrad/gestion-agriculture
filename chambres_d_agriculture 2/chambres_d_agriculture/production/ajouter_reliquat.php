...
if(isset($_POST['Submit'])){
  ...
  $stm = $db->prepare('UPDATE vignette SET reliquat=(reliquat + ?) ,Somme_disp=(Somme_disp+?)  WHERE id_vign=?');
...
$stm->execute([
    ...
    header("LOCATION: vignette_car.php");
...
$stm = $db->prepare('select reliquat from vignette WHERE id_vign=?');
 $stm->execute([$_GET['id']]);
