...
{
  $stm = $db->prepare('delete from vidange where Id_vidange=?');
    $stm->execute([$_GET['id']]);
}
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Liste des Vidanges<small></small></h2>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                         ...
                         <th class="center"><Small>Type du Vidange </Small></th>
                          <th class="center"><Small>Type de huile</Small></th>
                      
                          <th class="center"><Small>Description </Small></th>
                          <th class="center"><Small>Prix du vidange</Small></th>
                       ...
                       <?php
                       //$row['id_voiture']
                $stm = $db->prepare('select * from vidange');
                $stm->execute();
              ...
              ?>
                              ...
                              <tr>
                          <td class="center"><Small><?php echo $row1['Marque']; ?></Small></td>
                          <td class="center"><Small><?php echo $row1['Matricule']; ?></Small></td>

                          <?php } ?>
                          <td class="center"><Small><?php echo $row['Type_vidange']; ?></Small></td>
                          <td class="center"><Small><?php echo $row['type_huile']; ?></Small></td>
                          <td class="center"><Small><?php echo $row['Descriptif']; ?></Small></td>
                          <td class="center"><Small><?php echo $row['prix_vidange']; ?></Small></td>
                         
                          
                          <td class="center">
                  

                    <a class="btn btn-default btn-sm " href="modifier_vidange.php?id=<?php echo $row['Id_vidange']; ?>">
                     <i class="fa fa-refresh glyphicon-edit" title="Modifier" style="color:black;"></i> 
                  </a>

                <a class="btn btn-default btn-sm" href="?action=delete&id=<?php echo $row['Id_vidange']; ?>">
