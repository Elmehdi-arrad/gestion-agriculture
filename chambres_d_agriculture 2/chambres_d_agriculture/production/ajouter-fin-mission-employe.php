...
$stm = $db->prepare(' UPDATE  cahier_bord SET compteur_arrive=?,km_parcouru=?,etat_misdion=1 WHERE id_cahier=?');

$stm->execute([$_POST['compteur_arrive'],$_POST['km_parcouru'],$_GET['id']]);    
  
     

   header("LOCATION: liste-mission.php");
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <span class="section">Veuillez remplir les informations  d'une Mission terminer pour Employé</span>
...
/*
 ...
 value="<?php echo $row['compteur_depart'];?>"
 ...
 ?>
     ...
     <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Compteur KM  depart
                        </label>
  ...
  <input type="text" placeholder="" class="form-control"  >
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Compteur KM  arriver<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="compteur_arrive">
                  </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Distance parcouru<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
<input type="text" placeholder="" class="form-control" name="km_parcouru" >
                  </div>
                      </div>
