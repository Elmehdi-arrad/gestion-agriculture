                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                          <select class="form-control" name="type_Reparation">
                            ...
                            <option value="Chengement de piece">Chengement de piéce</option>
                    ...
                    <?php } ?>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="prix_Reparation" value="<?php echo $row['prix_rep'] ?>" >
                  </div>
                      </div>
                      <div class="item form-group">
