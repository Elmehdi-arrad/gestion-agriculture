...
if(isset($_POST['Submit'])){
  ...
  $stm = $db->prepare('UPDATE vignette_rep SET reliquat=(reliquat + ?) ,Somme_disp=(Somme_disp+?)  WHERE id_vign_rep=?');
...
$stm = $db->prepare('select reliquat from vignette_rep WHERE id_vign_rep=?');
 $stm->execute([$_GET['id']]);
