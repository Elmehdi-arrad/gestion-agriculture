...
if(isset($_POST['Submit'])){
  ...
  $stm = $db->prepare('UPDATE vignette_auto SET reliquat=(reliquat + ?) ,Somme_disp=(Somme_disp+?)  WHERE id_vign_auto=?');


$stm->execute([
     $_POST['Reliquat'],$_POST['Reliquat'],
     $_GET['id']]);

    header("LOCATION: vignette_autoroute.php");
...
$stm = $db->prepare('select reliquat from vignette_auto WHERE id_vign_auto=?');
 $stm->execute([$_GET['id']]);
                ...
                { ?>
                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12" >Reliquat : <span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
  <input type="text" placeholder="" class="form-control" name="Reliquat" value="<?php echo $row['reliquat'];?>">
                  </div>
                      </div>
