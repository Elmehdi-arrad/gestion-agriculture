...
$stm = $db->prepare(' UPDATE `vidange` set  id_voiture=?, Type_vidange=?, type_huile=?, Descriptif=?,prix_vidange=? WHERE Id_vidange=?');

$stm->execute([$_POST['voiture'],$_POST['vidange'],$_POST['type_huile'],$_POST['Description'],$_POST['prix_vidange'],$_GET['id']]);    
        ...
        <div class="right_col" role="main">
          <!-- Id_vidange="'.$_GET['id'].'" -->
           <div class="x_content">
             ...
             <?php
              $stm = $db->prepare('select * from vidange WHERE    Id_vidange="'.$_GET['id'].'"');
                $stm->execute();
                ...
                { ?>
                   <form class="form-horizontal form-label-left"  method="post">
                    ...
                    <?php } ?>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Type du Vidange : <span class="required">*</span></label>
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                          <select class="form-control" name="vidange">
                            <option><?php echo $row['Type_vidange']; ?> </option>
                            <option value="Vidange Simple">Vidange Simple</option>
                            <option value="Vidange avec filtre a huile">Vidange avec filtre a huile</option>
                            <option value="Vidange avec filtre d'aire">Vidange avec filtre d'aire</option>
                            <option value="Vidange avec filtre a gazoil">Vidange avec filtre a gazoil</option>
                            <option value="Vidange avec chaine de Distribution">Vidange avec chaine de Distribution</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                          <select class="form-control" name="type_huile">
                            <option><?php echo $row['type_huile']; ?> </option>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="Description" value="<?php echo $row['Descriptif'] ?>">
                  </div>
                      </div>
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="prix_vidange" value="<?php echo $row['prix_vidange']; ?> " >
                  </div>
                      </div>
