         ...
         <div class="row">
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                         ...
                         <th class="center"><Small>Motif </Small></th>
                          ...
                          <th class="center"><Small>Voiture</Small></th>
                           ...
                           <th class="center"><Small>Fin Mission</Small></th>
                       ...
                       <?php
                       //$row['id_voiture']
                $stm = $db->prepare('select * from cahier_bord where etat_misdion=0 order by date_depart DESC');
                $stm->execute();
              ...
              ?>
                       ...
                       //$row['id_voiture']
                           if($row['id_voiture']==0)
                            {
                        echo "<td class='center'><Small>Autre</Small></td>";
                        echo "<td class='center'><Small>Autre</Small></td>";
              ...
              ?>
               ...
               <td class="center"><Small><?php echo $row2['Matricule']; ?></Small></td>
                    ...
                    <a class="btn btn-default btn-sm " href="ajouter-fin-mission-employe.php?id=<?php echo $row['id_cahier']; ?>">
                     <i class="fa fa-refresh glyphicon-edit" title="Fin Mission " style="color:black;"></i> 
                  </a>
