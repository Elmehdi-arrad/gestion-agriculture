        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left"  method="post">
                      ...
                      <span class="section">Veuillez remplir les informations D'une Mission Personne</span>

                      <div class="item form-group ">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Employer <span class="required">*</span>
                        </label>
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="empoye">
                  </div>
                      </div>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="motif_mission">
                  </div>
                      </div>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="date" placeholder="" class="form-control" name="date_departe">
                  </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Compteur Départ<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="Compteur_departe">
                  </div>
                      </div>
                      <div class="item form-group">
                    ...
                    <input type="text" placeholder="" class="form-control" name="Destination">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Prix Autoroute<span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="Prix_autorute">
                  </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="text" placeholder="" class="form-control" name="Prix_carburant">
                  </div>
                      </div>
                      

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Selecte Voiture du Mission <span class="required">*</span>
                        </label>
                       <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="" placeholder="" class="form-control" name="voiture">
                  </div>
                      </div>
