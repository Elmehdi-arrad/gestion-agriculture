...
{
  $stm = $db->prepare('delete from vignette_auto where id_vign_auto=?');
    $stm->execute([$_GET['id']]);
}
...
<html lang="en">
        ...
        <div class="right_col" role="main">
         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Liste vignette VTT<small></small></h2>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          ...
                          <tbody>
                       <?php
                $stm = $db->prepare('select * from vignette_auto 
 ...
 <td class="center"><Small><?php echo $row['Somme_disp'];?></Small></td>
                 ...
                 <a class="btn btn-default btn-sm" href="ajouter_reliquat_auto.php?id=<?php echo $row['id_vign_auto']; ?>">
                 <i class="glyphicon glyphicon-plus" title="Ajouter reliquat" style="color:black;"></i> 
                  </a>
                                  </td>
                          <td class="center">
                
                <a class="btn btn-default btn-sm" href="?action=delete&id=<?php echo $row['id_vign_auto']; ?>">
